...
export function TimetableCard({ language }: TimetableCardProps) {
  ...
  const translations = {
    ...
    pa: {
      ...
      noClasses: 'ਅੱਜ ਲਈ ਕੋਈ ਕਲਾਸਾਂ ਨਹੀਂ ਹਨ',
      noTimetable: 'ਸਮਾਂ ਸਾਰਣੀ ਉਪਲਬਧ ਨਹੀਂ ਹੈ',
      period: 'ਪੀਰੀਅਡ',
      teacher: 'ਅਧਿਆਪਕ',
    ...
    hi: {
      title: 'समय सारिणी',
      subtitle: 'आज का कार्यक्रम',
      noClasses: 'आज के लिए कोई कक्षाएं निर्धारित नहीं हैं',
      noTimetable: 'समय सारिणी उपलब्ध नहीं है',
      period: 'पीरियड',
      teacher: 'शिक्षक',
    ...
    >
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          <div className="p-2 rounded-lg bg-gradient-to-br from-emerald-500 to-teal-500 text-white shadow-sm">
            <Calendar className="w-5 h-5" />
          </div>
          <div>
            <h3 className="text-base sm:text-lg font-semibold">{t.title}</h3>
      ...
      {todayEntries.length === 0 ? (
        ...
        <div className="space-y-3 max-h-64 overflow-y-auto">
          {todayEntries.map((entry) => (
            <div
              key={entry.id}
              className="p-4 rounded-lg bg-gray-50 dark:bg-slate-800 border border-gray-200 dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-slate-700 transition"
            >
              <div className="flex items-start justify-between mb-2">
                <div className="flex-1">
                  <div className="flex items-center gap-2 mb-1">
                    <span className="px-2 py-0.5 rounded-md bg-emerald-50 text-emerald-600 dark:bg-emerald-900/20 dark:text-emerald-400 text-[10px] font-bold">
