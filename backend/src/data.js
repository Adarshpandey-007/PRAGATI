...
const schools = [
  {
    id: "1",
    name: "Mock Test Government Senior Secondary School",
...
const classrooms = [
  {
    id: "201",
    schoolId: "1",
    grade: { id: "g10", name: "Grade 10", level: 10 },
...
const complaints = [
  {
    id: "c1",
    status: "open",
    title: "Mock test complaint: drinking water",
    schoolId: "1",
    mockTag: MOCK_TAG,
  },
];
...
const notifications = [
  {
    ...
    body: "This is labeled mock test data for platform validation.",
  ...
  "7": [
    {
      ...
      classroom: { id: "201", grade: { name: "Grade 10" }, section: { label: "A" } },
      room: "101",
      mockTag: MOCK_TAG,
    },
  ],
...
const programs = [
  {
    ...
    practicalUse:
      "Track meal-day attendance consistency, identify low-turnout days, and trigger school-level nutrition compliance checks.",
    eligibility: [
    ...
    implementationChecklist: [
      ...
      "Flag schools with mismatch between attendance and meal numbers",
  ...
  },
  {
    ...
    practicalUse:
      "Map attendance stability, retention patterns, and participation metrics to NEP-aligned quality and access goals.",
    eligibility: [
  ...
  },
  {
    ...
    ministry: "Ministry of Education",
    practicalUse:
      "Use attendance and infrastructure-linked performance to identify PM SHRI model school readiness and monitor outcomes.",
    eligibility: [
